...
void fiberCounter_monitor(const char* dbn = "42", const char* ed = "N", const char * input_folder = "test", const char * output_folder = "test", const char * output_csv = "test/result.csv"){

//This part of code automatically crops the picture.
  TString pic = Form("%s/%s_%s.JPG",input_folder,dbn,ed);
