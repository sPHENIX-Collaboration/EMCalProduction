...
void fiberCounter_new(const char* dbn = "42", const char* ed = "N", const char * input_folder = "test", const char * output_folder = "test", const char * output_csv = "test/result.csv"){
...
//This part of code automatically crops the picture.
  ...
  h1dmax->GetXaxis()->SetRangeUser(absBkg+50,256);
  TH1D* h1dmin = (TH1D*)h1d->Clone("h1dmin");
  h1dmin->GetXaxis()->SetRangeUser(absBkg+50,h1dmax->GetMaximumBin()*h1dmax->GetBinWidth(h1dmax->GetMaximumBin()));
